...
public class ICanWinTest extends BaseTest {
    ...
    public void createNewGist () {
        ...
        CreateGistPage createGistPage = new CreateGistPage().openPage()
                                                            .fillGistDescription(DESCRIPTION)
                                                            .fillFileName(NAME)
                                                            .fillFileEditorArea(TEXT)
                                                            .clickOnCreatePublicGistButton();
        UserGistPage userGistPage = new UserGistPage().openUserPage(LOGIN).setCurrentGist(NAME).clickCurrentGist();
